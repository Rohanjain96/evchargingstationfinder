...
const BottomTabNavigator = () => {
  return (
    <Tab.Navigator>
      <Tab.Screen name="Mapscreen" component={MapScreen} options={{tabBarIcon:()=>{
